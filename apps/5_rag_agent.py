...
def process_document(path):
    ...
    system_prompt = """You are a helpful assistant that answers questions using retrieved context of MY knowledge base that 
    consists of the details from the uploaded documents . ALWAYS use the `retrieve_context` tool for questions requiring external 
    knowledge"""
...
###--------- FOR RUNNING IN TERMINAL OR CONSOLE WINDOW ---------
# while True:
#     query = input("User :")
#     if query.lower() == "quit":
#         break 
...
### STREAMLIT UI FOR FILE UPLOAD AND CHAT UI -----------------------------------------
